function New-RandomPassword
{
  <#
   # Stolen from MS and edited to generate pwds when run.
    ...
    .EXAMPLE
        New-RandomPassword -Count 20 -Length 12 -Source abcdefghijklmnopqrstuvwxyz, ABCDEFGHIJKLMNOPQRSTUVWXYZ, 0123456789
 
        Generates 20 passwords with a length of 12 containing at least one char from each string in Source
    .EXAMPLE
    ...
    .EXAMPLE
        ...
        Generates four passwords with a lenght of 12 characters while excluding similar characters "Il1O05S2Z"
  #>
    [CmdletBinding()]
    [OutputType([string])]
    Param
